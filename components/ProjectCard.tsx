...
export default function ProjectCard({ title, description, href, icon }: ProjectCardProps) {
  return (
    <ExternalLink href={href} styles="mb-4">
      <div className="flex items-center p-4 rounded-lg border border-gray-200 hover:border hover:shadow-sm dark:border-gray-200 dark:hover:border-2">
        {icon === "reactweather" && (
          <div className="mr-4 ml-2 w-8 h-8">
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="w-6 h-6 stroke-current text-slate-900 dark:bg-transparent dark:text-white"
            >
              <path
                strokeLinecap="round"
        ...
        {icon === "ampathforms" && (
          <div className="mr-4 ml-2 w-8 h-8">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 500 500"
              className="w-6 h-6 fill-current text-slate-900 dark:text-white"
            >
        ...
        <div className="space-y-1">
          <h4 className="font-semibold tracking-tight prose text-slate-600 dark:text-white">{title}</h4>
          <p className="leading-5 prose text-slate-600 dark:text-slate-400">{description}</p>
        </div>
      </div>
    </ExternalLink>
  );
