...
export default function ProjectCard({ title, description, href, icon }) {
  return (
    <ExternalLink href={href} styles="mb-4">
      <div className="flex items-center border rounded-lg hover:border hover:shadow border-gray-200 dark:border-gray-200 dark:hover:border-2 p-4">
        {icon === "reactweather" && (
          <div className="h-8 w-8 ml-2 mr-4">
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="h-6 w-6 dark:bg-transparent stroke-current text-gray-900 dark:text-white"
            >
              <path
                strokeLinecap="round"
        ...
        {icon === "ampathforms" && (
          <div className="h-8 w-8 ml-2 mr-4">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 500 500"
              className="h-6 w-6 text-gray-900 dark:text-white fill-current"
            >
