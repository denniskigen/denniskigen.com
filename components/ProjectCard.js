    ...
    <ExternalLink href={href} styles="mb-4">
      <div className="flex items-center rounded-lg border border-gray-200 p-4 hover:border hover:shadow dark:border-gray-200 dark:hover:border-2">
        {icon === "reactweather" && (
          <div className="ml-2 mr-4 h-8 w-8">
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="h-6 w-6 stroke-current text-slate-900 dark:bg-transparent dark:text-white"
            >
              <path
                strokeLinecap="round"
        ...
        {icon === "ampathforms" && (
          <div className="ml-2 mr-4 h-8 w-8">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 500 500"
              className="h-6 w-6 fill-current text-slate-900 dark:text-white"
            >
        ...
        <div className="space-y-1">
          <h4 className="prose font-semibold tracking-tight text-slate-600 dark:text-white">
            {title}
          </h4>
          <p className="prose leading-5 text-slate-600 dark:text-slate-400">
            {description}
          </p>
        </div>
      </div>
